...
const aiTools = [
  {
    ...
    tags: ['免费', '中文', 'API'],
    free: true, chinese: true, hot: true, featured: true,
    rating: 4.9, users: '10M+',
  ...
  },
  {
    ...
    tags: ['付费', '英文'],
    free: false, chinese: false, hot: true, featured: true,
    rating: 4.8, users: '5M+',
  ...
  },
  {
    ...
    category: 'AI绘画', catColor: '#c792ea',
    tags: ['免费', '开源', '本地部署'],
    free: true, chinese: false, hot: true, featured: true,
    rating: 4.7, users: '6M+',
  ...
  },
  {
    ...
    tags: ['付费', '中文'],
    free: false, chinese: true, hot: false, featured: true,
    rating: 4.6, users: '3M+',
    url: 'https://notion.so',
  ...
  },
  {
    ...
    category: '对话助手', catColor: '#64ffda',
    tags: ['免费', '中文'],
    free: true, chinese: true, hot: true, featured: false,
    rating: 4.5, users: '7M+',
  ...
  },
  {
    ...
    category: 'AI绘画', catColor: '#c792ea',
    tags: ['付费', 'API'],
    free: false, chinese: false, hot: false, featured: false,
    rating: 4.7, users: '2M+',
  ...
  },
  {
    ...
    category: 'AI办公', catColor: '#ffd700',
    tags: ['免费', '中文'],
    free: true, chinese: true, hot: false, featured: false,
    rating: 4.5, users: '2M+',
    url: 'https://gamma.app',
  ...
  },
  {
    ...
    tags: ['付费', '英文'],
    free: false, chinese: false, hot: true, featured: false,
    rating: 4.6, users: '3M+',
...
module.exports = { aiTools, categories }
